...
| Topics | Must link to at least one map | Check for `topics:` in YAML or `Topics:` section in footer. Must contain at least one wiki link |
...
| Topics links | Map referenced in Topics must exist | Verify each topic wiki link resolves |
